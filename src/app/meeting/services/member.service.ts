...
export class MemberService {
  private apiUrl = 'https://managewise-ffbua6fpfmbteaeq.centralus-01.azurewebsites.net/api/v1/members';

  constructor(private http: HttpClient) { }

  // Obtener todos los miembros
  getAll(): Observable<Member[]> {
    return this.http.get<Member[]>('https://managewise-ffbua6fpfmbteaeq.centralus-01.azurewebsites.net/api/v1/members');
  }
